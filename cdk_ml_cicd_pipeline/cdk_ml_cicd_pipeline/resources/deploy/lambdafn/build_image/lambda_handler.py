...
def handler(event, context):
    ...
    environment_variable = [
        {"name": "COMPONENT_IMAGE_REPOSITORY", "value": component_image_repo, "type": "PLAINTEXT"},
        {"name": "COMPONENT_BASE_IMAGE_REPOSITORY", "value": component_image_base_repo, "type": "PLAINTEXT"},
        {"name": "IMAGE_TAG", "value": event["version"], "type": "PLAINTEXT"},
        {"name": "S3_URI", "value": event["s3object"], "type": "PLAINTEXT"},
        {"name": "FILE_NAME", "value": event["s3object"].split("/")[-1], "type": "PLAINTEXT"},
        {"name": "COMPONENT_APP_SOURCE_REPOSITORY", "value": component_app_repo, "type": "PLAINTEXT"},
        {"name": "ACCOUNT_ID", "value": boto3.client("sts").get_caller_identity()["Account"], "type": "PLAINTEXT"},
    ]

    client = boto3.client("codebuild")
    res = client.start_build(projectName=codebuild_project_name, environmentVariablesOverride=environment_variable)
